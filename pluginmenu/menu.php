 ...
 * @since 1.0.0
 */
if ( ! function_exists( 'azrcrv_create_plugin_menu_gff' ) ) {
	function azrcrv_create_plugin_menu_gff() {
		azrcrv_populate_plugin_menu_gff();
	}
}
 ...
 * @since 1.0.0
 */
if ( ! function_exists( 'azrcrv_populate_plugin_menu_gff' ) ) {
	function azrcrv_populate_plugin_menu_gff() {
