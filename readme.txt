...
Download link:	https://github.com/azurecurve/azrcrv-gallery-from-folder/releases/download/v2.1.3/azrcrv-gallery-from-folder.zip
 ...
 * Download the latest release of the plugin from [GitHub](https://github.com/azurecurve/azrcrv-gallery-from-folder/releases/latest/).
...
### [Version 2.1.3](https://github.com/azurecurve/azrcrv-gallery-from-folder/releases/tag/v2.1.3)
 * Update readme file for compatibility with ClassicPress Directory.
 
### [Version 2.1.2](https://github.com/azurecurve/azrcrv-gallery-from-folder/releases/tag/v2.1.2)
 * Update readme files.
 * Update language template.
 * Fix bug with azurecurve menu.
 
### [Version 2.1.1](https://github.com/azurecurve/azrcrv-gallery-from-folder/releases/tag/v2.1.1)
 * Update azurecurve menu.
 * Update readme files.

### [Version 2.1.0](https://github.com/azurecurve/azrcrv-gallery-from-folder/releases/tag/v2.1.0)
 * Add uninstall.
